...
import { FaAws, FaChartBar, FaMicrochip, FaRobot } from 'react-icons/fa';
...
export const skills: Skill[] = [
    ...
    { name: 'AI & ML', icon: FaRobot, category: 'Data & Tools' },
    { name: 'Data Science', icon: FaChartBar, category: 'Data & Tools' },
];